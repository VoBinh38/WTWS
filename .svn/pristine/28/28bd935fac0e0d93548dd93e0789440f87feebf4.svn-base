...
namespace PURCHASE
{
    public partial class SearchVENDC1B : Form
    {
        ...
        public void LoadData()
        {
            ...
            //C_NO,C_NAME,C_ANAME,ADR1,S_NO,ADR2,ADR3,ADR4,PAY_CON,DEFA_MONEY,RCV_DATE
        ...
        private void Data()
        {
            ...
            getDataTable.C_NAME = dataGridViewdoanhnghiep2.CurrentRow.Cells[1].Value.ToString();
            getDataTable.C_ANAME = dataGridViewdoanhnghiep2.CurrentRow.Cells["C_ANAME"].Value.ToString();
            getDataTable.ADR1 = dataGridViewdoanhnghiep2.CurrentRow.Cells["ADR1"].Value.ToString();
            getDataTable.DEFA_MONEY = dataGridViewdoanhnghiep2.CurrentRow.Cells["DEFA_MONEY"].Value.ToString();
            this.Hide();
        }
