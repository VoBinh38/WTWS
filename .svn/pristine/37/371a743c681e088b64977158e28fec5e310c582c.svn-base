...
namespace PURCHASE.MAINCODE.Modun4.Report {
    ...
    public class cr_Frm4BF7_2 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "PURCHASE.MAINCODE.Modun4.Report.cr_Frm4BF7_2.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cachedcr_Frm4BF7_2 : Component, ICachedReport {
        
        public Cachedcr_Frm4BF7_2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            cr_Frm4BF7_2 rpt = new cr_Frm4BF7_2();
            rpt.Site = this.Site;
            return rpt;
        }
