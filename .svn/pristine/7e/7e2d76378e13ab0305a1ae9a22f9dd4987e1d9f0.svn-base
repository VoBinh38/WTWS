...
namespace PURCHASE.MAINCODE.Modun4.Report {
    ...
    public class cr_frm4BF7_7 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "PURCHASE.MAINCODE.Modun4.Report.cr_frm4BF7_7.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cachedcr_frm4BF7_7 : Component, ICachedReport {
        
        public Cachedcr_frm4BF7_7() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            cr_frm4BF7_7 rpt = new cr_frm4BF7_7();
            rpt.Site = this.Site;
            return rpt;
        }
