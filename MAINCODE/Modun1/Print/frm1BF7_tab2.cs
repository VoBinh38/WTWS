...
{
    public partial class frm1BF7_tab2 : Form
    {
        public frm1BF7_tab2()
        {
        ...
        private void frm1BF7_tab2_Load(object sender, EventArgs e)
        {
            ...
            {
                cryRpt = new Cr_Form1BF7_Tab2_1();
            }
            else
            {
                cryRpt = new Cr_From1BF7_Tab2_2();
            }
